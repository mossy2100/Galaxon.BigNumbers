...
public class BigDecimalRootTests
{
    ...
    public void TestRootNLargeNIntegerA()
    {
        ...
        // Test BigInteger.Pow().
        BigDecimal powExpected = BigDecimal.Parse("");
    ...
    {
        BigDecimal actual = BigDecimal.RootN(-27, 5);
